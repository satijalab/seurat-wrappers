...
Having fitted and visualized the topic model, our next aim is to
annotate the topics by identify genes that are distinctive to each
topic. To do this, we perform a "grade of membership" differential
expression analysis (GoM DE):
...
Note this step may take some time to run on your computer---10 minutes
or perhaps more. This is an expensive step because estimation of the
key posterior statistics is performed using Monte Carlo simulations.
...
```
>>>>>>> 4645464cd6aba9989a50512c33f7ce128a0200b5

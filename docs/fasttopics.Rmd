...
bar heights correspond to topic proportions (which sum to 1 for each
cell).
...
cells---these are T cells that sometimes become ``NK-like''---and this
is captured in the topic model by assigning membership to both topics
2 and 5.

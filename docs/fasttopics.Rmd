...
preprocessing or pre-selection of genes is needed.** It may
take several minutes to fit the model.
...
plot provides an evocative visual summary of the estimated mixture

...
providing the location of cell centroids or spots explicitly. Here, we use
a mouse hippocampus VeraFISH dataset provided with the *Banksy* package.
...
Now, run BANKSY. Here, we provide the locations of cell centroids explicitly
with the `locations` argument:

...
remotes::install_github(repo = "cole-trapnell-lab/monocle3", upgrade = FALSE)
```
...
```{r integration_hca, results='hide'}
...
```{r monocle3_hca, results='hide', fig.height=10, fig.width=16}
